...
if($_POST)
{
  ...
  if(!$errors)
  {
  $sql = "INSERT INTO School(name,username,email,city,address,contact,password) VALUES
  ('".$name."','".$username."','".$email."','".$city."','".$address."','".$contact."','".$password."')";
  ...
  <body>
    <div class="limiter">
          ...
          <div class="messages">
            ...
            <div class="wrap-input100 validate-input" data-validate = "Enter contant no.">
              <input class="input100" type="text" name="contact" placeholder="Contactno">
              <span class="focus-input100" ></span>
            </div>
